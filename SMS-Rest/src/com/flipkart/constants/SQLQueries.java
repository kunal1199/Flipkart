...
public class SQLQueries {
	//Queries for the admin REST module
	...
	public static final String ADD_COURSE = "insert into course(id, catalogid, `course name`, fees) values(?, ?, ?, ?)";
	public static final String DROP_COURSE = "delete from course where id=?";
	public static final String UPDATE_COURSE = "update course set id=?, catalogid=?, `course name`=?, fees=? where id=?";
	
	public static final String VIEW_USERS = "select * from users";
	public static final String VIEW_USER_BY_ID = "select * from users where id=?";
	...
	public static final String UPDATE_USER = "update users set id=?, username=?, password=?, roleId=?, gender=? where id=?";
